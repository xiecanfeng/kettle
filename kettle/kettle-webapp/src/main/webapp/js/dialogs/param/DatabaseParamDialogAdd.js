DatabaseParamDialogAdd = Ext.extend(Ext.Window, {
	title: '数据库连接',
	width: 700,
	height: 550,
	closeAction: 'close',
	...
	initComponent: function() {
		...
		var bOk = new Ext.Button({
			text: '确定', handler: function() {
				Ext.Ajax.request({
					url: GetUrl('database/checkAndSave.do'),
					method: 'POST',
					params: {databaseInfo: Ext.encode(me.getValue())},
					success: function(response) {
		...
		DatabaseParamDialogAdd.superclass.initComponent.call(this);
		
		this.addEvents('create')
	}
});

Ext.reg('DatabaseParamDialogAdd', DatabaseParamDialogAdd);
