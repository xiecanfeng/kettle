...
<html>
	...
	<body>
	    ...
	    <script type="text/javascript" src="${pageContext.request.contextPath}/js/dialogs/trans/TransSqlDialog.js"></script>
	    ...
	    <script type="text/javascript" src="${pageContext.request.contextPath}/js/dialogs/log/LogManageDialog.js"></script>
	    <script type="text/javascript" src="${pageContext.request.contextPath}/js/dialogs/log/TransLogManageTab.js"></script>
	    <script type="text/javascript" src="${pageContext.request.contextPath}/js/dialogs/log/JobLogManageTab.js"></script>
	    ...
	    <script type="text/javascript" src="${pageContext.request.contextPath}/js/dialogs/param/ParamDialog.js"></script>
	    <script type="text/javascript" src="${pageContext.request.contextPath}/js/dialogs/param/ParamTab.js"></script>
	    <script type="text/javascript" src="${pageContext.request.contextPath}/js/dialogs/param/DatabaseParamDialog.js"></script>
	    <script type="text/javascript" src="${pageContext.request.contextPath}/js/dialogs/param/DatabaseParamDialogAdd.js"></script>
	    <script type="text/javascript" src="${pageContext.request.contextPath}/js/dialogs/param/DatabaseParamTab.js"></script>
