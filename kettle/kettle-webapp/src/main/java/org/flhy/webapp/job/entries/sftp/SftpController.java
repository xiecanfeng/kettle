...
public class SftpController extends BaseController{
	...
	protected void sftptest(@RequestParam String graphXml, @RequestParam String stepName,ModelMap model) throws Exception {
	...
	protected void sftpdirtest(@RequestParam String graphXml, @RequestParam String stepName,ModelMap model) throws Exception {
		GraphCodec codec = (GraphCodec) PluginFactory.getBean(GraphCodec.JOB_CODEC);
		App app = (App) model.get("app");
		JobMeta jobMeta = (JobMeta) codec.decode(graphXml,app);
