...
//			attributesMap = AttributesUtil.loadAttributes(XMLHandler.getSubNode(entrynode, AttributesUtil.XML_TAG));
	...
	@Override
	public Element encodeStep(JobEntryCopy je,App app) throws Exception {
		Element e = encode(je.getEntry(),app);
	...
	public abstract Element encode(JobEntryInterface jobEntry,App app) throws Exception;
