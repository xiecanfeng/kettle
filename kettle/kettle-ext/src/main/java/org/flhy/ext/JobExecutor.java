...
//	private Map<StepMeta, String> stepLogMap = new HashMap<StepMeta, String>();
	...
	private JobExecutor(JobExecutionConfiguration executionConfiguration, JobMeta jobMeta,App app) {
	...
	public static synchronized JobExecutor initExecutor(JobExecutionConfiguration executionConfiguration, JobMeta jobMeta,App app) {
		JobExecutor jobExecutor = new JobExecutor(executionConfiguration, jobMeta,app);
	...
	public void run() {
		try {
			...
			if (executionConfiguration.isExecutingLocally()) {
			     ...
			     job = new Job( app.getRepository(), jobMeta, spoonLoggingObject );
				...
				carteObjectId = Job.sendToSlaveServer( jobMeta, executionConfiguration, app.getRepository(), app.getMetaStore() );
